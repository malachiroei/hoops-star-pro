    ...
    <div className="p-4 space-y-6 pb-20 text-right" dir="rtl">
      ...
      <Tabs defaultValue="workout" className="w-full">
        ...
        <TabsContent value="nutrition" className="mt-4 space-y-4">
          <Card className="glass-card bg-slate-900/50 border-white/10 text-right">
            <CardHeader><CardTitle>תפריט תזונה</CardTitle></CardHeader>
            <CardContent className="text-sm text-purple-400 italic font-bold">נשנושים של ניסוי 🧪 מעל ארוחת ערב.</CardContent>
          </Card>
        </TabsContent>

        <TabsContent value="moves" className="mt-4">
          <Card className="glass-card bg-slate-900/50 border-white/10 text-right">
            <CardHeader><CardTitle>מהלכי כדורסל</CardTitle></CardHeader>
            <CardContent className="text-sm text-slate-400">סרטוני הדרכה לשיפור השליטה בכדור.</CardContent>
          </Card>
        </TabsContent>
